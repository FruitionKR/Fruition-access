...
인증·OAuth·세션·워크스페이스·권한을 담당하는 독립 Spring Boot 서비스입니다. 이 폴더 전체가 GitHub 저장소 루트가 됩니다.
...
An independent Spring Boot service for authentication, OAuth, sessions, workspaces, and authorization. This directory is the GitHub repository root.
